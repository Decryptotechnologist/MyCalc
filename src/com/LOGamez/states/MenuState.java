...
public class MenuState implements State {
    ...
    private int menuImageW = Calc.getMainWidth()+12;
    
    /**menuImageH variable of MenuState*/
    private int menuImageH = Calc.getMainHeight()-15;
    ...
    private int aboutBtnX = Calc.getMainWidth() - 90;
    
    /**aboutBtnY variable of MenuState*/
    private int aboutBtnY = Calc.getMainHeight() - 100;
    ...
    private int versionX = Calc.getMainWidth() - 50;
    
    /**versionY variable of MenuState*/
    private int versionY = Calc.getMainHeight() - 40;
...
//                    Sound.btnPushed.play();
		...
		Calc.setStatusBar("Quit?");
                
                //Set Quit Button Click Logic
                if (MouseInput.MouseButton == 1) {
//                    Sound.stopAll();
//                    Sound.btnPushed.play();
                    Calc.setStatusBar("Quit Game?");
