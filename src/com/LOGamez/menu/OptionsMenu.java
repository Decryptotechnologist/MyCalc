...
//    private Configuration config;
    ...
    */
    ...
    private void initComponents() {
        ...
        lgePanelSize = new Dimension(Calc.getMainWidth() - 40, Calc.getMainHeight() - 20);
        ...
        mainPanel = new JPanel(){
            ...
            protected void paintComponent(Graphics g) {
                ...
                g.drawImage(mainPanelImage, 0, -10, Calc.getMainWidth() - 40, Calc.getMainHeight() - 20, null);
            }
        };
...
//        jCheckBox16.setOpaque(false);
        ...
        Calc.optionsWindow.add(mainPanel);
...
//                Sound.Menu3.loop();
            ...
            Calc.addOptions();
            Calc.setStatusBar("Options Menu");
            Calc.optionsWindow.validate();
...
//    }
    ...
    */
    ...
    private void restoreDefBtnMouseEntered(MouseEvent evt) {  
        ...
        Calc.setStatusBar("Restore Defaults");
    }                                     
    ...
    private void backBtnMouseEntered(MouseEvent evt) {                                      
        ...
        Calc.setStatusBar("Back to Main Menu");
    }                                     
...
//        Sound.Menu3.stop();
        ...
        game.setCredits();
        game.requestFocus();
        Calc.setStatusBar("Credits Menu");
    }
...
//        Sound.Menu3.stop();
        ...
        game.setMenu(null);
        game.stateManager.setState("menu");
        Calc.setStatusBar("Define Keys Menu");
    }
    ...
    private void defKeysBtnMouseEntered(MouseEvent evt) {
        ...
        Calc.setStatusBar("Default Keys");
    }                                     
