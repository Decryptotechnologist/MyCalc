...
public class LoseMenu extends Menu {
    ...
    private final int menuImageW = Calc.getMainWidth()+12;
    
    /**menuImageH variable of LoseMenu*/
    private final int menuImageH = Calc.getMainHeight();
...
//            Sound.stopAll();
            ...
            Game.level = new Level(1, Calc.getMainWidth(), Calc.getMainHeight());
