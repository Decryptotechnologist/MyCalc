...
public class Game extends Canvas implements Runnable {
    ...
    public static String TITLE = "MyCalc";
...
//        }
        ...
        img = new BufferedImage(Calc.getMainWidth(), Calc.getMainHeight(), BufferedImage.TYPE_INT_RGB);
    ...
    private void init(){
        ...
        if(level == null){
            levelNo = startLevel;
            Game.level = new Level(levelNo, Calc.getMainWidth(), Calc.getMainHeight());
        }
...
//            win();
    ...
    */
    public void win() {
        ...
        Calc.setStatusBar("Time Bonus: "+timeBonus+" Accuracy Bonus: "+accuracyBonus+" Level Bonus: "+levelBonus);
        ...
        if(levelNo+1 < 21){//Game Levels Limit : Currently set to 8
            ...
            Calc.setStatusBar("Game Complete!");
