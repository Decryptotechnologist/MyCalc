...
public class Labels {
    ...
    public static void setUp(){
        int width = Calc.getMainWidth();
        switch(width){
            case 300:
                LabelScale = 0.75;
            
                scoreLabelX = Calc.getMainWidth() - 175;
                scoreLabelY = -12;
                scoreLabelBGCol = 0x0e8100;//Dark Green
                scoreLabelFGCol = 0xffffff;//White

                scoreX = Calc.getMainWidth() - 40;
                scoreY = 15;
                ...
                playerNameX = Calc.getMainWidth() / 2 - Game.getPName().length() * 5;
                playerNameY = 15;
                ...
                enterLevelNoScale = 1;
                enterLevelX = Calc.getMainWidth() / 6 - 30;//10
                enterLevelY = Calc.getMainHeight() - 175;

                LevelX = Calc.getMainWidth() - 150;//120
                LevelY = Calc.getMainHeight() - 174;

                LevelNoX = Calc.getMainWidth() - 60;//165
                LevelNoY = LevelY;

                click2FocusScale = 1;
                click2FocusX = Calc.getMainWidth() / 6;
                click2FocusY = Calc.getMainHeight() / 2 - 50;

                fpsX = 5;
                fpsY = Calc.getMainHeight() - 55;
                upsX = 5;
                upsY = Calc.getMainHeight() - 45;
            ...
            case 480:
                ...
                enterLevelNoScale = 2;
                enterLevelX = Calc.getMainWidth() / 6 - 30;
                enterLevelY = Calc.getMainHeight() - 375;

                LevelX = Calc.getMainWidth() - 290;
                LevelY = Calc.getMainHeight() - 374;

                LevelNoX = Calc.getMainWidth() - 135;
                LevelNoY = LevelY;
                ...
                fpsX = 5;
                fpsY = Calc.getMainHeight() - 115;
                upsX = 5;
                upsY = Calc.getMainHeight() - 95;
            ...
            case 604:
                ...
                scoreLabelX = Calc.getMainWidth() - 160;
                scoreLabelY = -22;
                scoreLabelBGCol = 0xe81000;//0x0e8100;//Dark Green
                scoreLabelFGCol = 0xffffff;//White

                scoreX = Calc.getMainWidth() - 70;
                scoreY = 15;
                ...
                enterLevelNoScale = 2;
                enterLevelX = Calc.getMainWidth() / 6 - 30;
                enterLevelY = Calc.getMainHeight() - 465;

                LevelX = Calc.getMainWidth() - 290;
                LevelY = Calc.getMainHeight() - 464;
