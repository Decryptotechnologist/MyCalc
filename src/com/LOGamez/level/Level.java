...
public class Level {
    ...
    public static double bgX = (Calc.getMainWidth()/5);
...
//                powScale = 0.75;
                ...
                groundX = 4;
                groundY = Calc.getMainHeight() - 140;
...
//                powScale = 0.75;
    ...
    private void init(){
        ...
        display = new Display(10,10, Calc.getMainWidth()-40, 40, "0");
        panel.add(display.textArea, BorderLayout.NORTH);
